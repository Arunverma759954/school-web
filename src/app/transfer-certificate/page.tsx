...
export default function TransferCertificatePage() {
    ...
    return (
                    ...
                    >
                        ...
                        <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-4 flex items-center gap-3 mb-6">
                            ...
                            <button
                                onClick={handlePrint}
                                id="downloadTCBtn"
                                className="ml-auto bg-green-500 hover:bg-green-600 text-white font-black uppercase tracking-widest text-[10px] px-5 py-2.5 rounded-xl flex items-center gap-2 transition-all duration-300 hover:-translate-y-0.5 shadow-[0_4px_20px_rgba(34,197,94,0.3)]"
                            >
                                <Download size={14} />
                                Download TC
                            </button>
        ...
        @media print {
          ...
          #tc-document, #tc-document * { visibility: visible; }
          #tc-document { position: fixed; top: 0; left: 0; width: 100%; }
        }
      `}</style>
        </>
    );
