                ...
                <div className="grid md:grid-cols-12 gap-12 mb-20">
                    ...
                    <div className="md:col-span-4 space-y-8">
                        <div className="flex flex-col items-start gap-8">
                            ...
                            <div>
                                <h4 className="text-2xl font-serif font-black mb-8 uppercase tracking-widest text-white">Contact Details</h4>
                                <div className="space-y-6 text-base text-white leading-relaxed font-bold tracking-wider">
                                    <p className="text-secondary text-lg">ST. MARTIN'S DIOCESAN SCHOOL</p>
                                    <div className="space-y-3 opacity-90">
                                        <p className="flex items-center gap-3"><MapPin size={18} className="text-secondary" /> CHURCH ROAD, DELHI CANTT-110010</p>
                                        <p className="flex items-center gap-3"><Phone size={18} className="text-secondary" /> +91-011-20895675, 20892683</p>
                                        <p className="flex items-center gap-3 ml-7">+91- 7701847614</p>
                                    </div>
                                    <div className="space-y-3 mt-6">
                                        <p className="text-secondary hover:underline cursor-pointer transition-all flex items-center gap-3">
                                            <Mail size={18} /> info@stmartinschooldelhicantt.com
                                        </p>
                                        <p className="text-secondary hover:underline cursor-pointer transition-all flex items-center gap-3">
                                            <Mail size={18} className="opacity-0" /> admissions@stmartinschooldelhicantt.com
                                        </p>
                                    </div>
                    ...
                    <div className="md:col-span-8 flex flex-col md:flex-row gap-12 md:gap-24">
                        <div className="flex-1 space-y-10">
                            <h4 className="text-2xl font-serif font-black uppercase tracking-widest text-white relative inline-block">
                                Quick Links
                                <span className="absolute -bottom-2 left-0 w-12 h-1 bg-secondary"></span>
                            </h4>
                            <ul className="space-y-4 font-bold text-base text-white/80">
                                {[
